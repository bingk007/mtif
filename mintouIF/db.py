...
class DB:
    ...
    def query(self, sql):
        conn = pymysql.connect(host='172.17.255.220', port=3306, user='root', passwd='123456', db='mtbill',
    ...
    def make_product(self):
        ...
        cur.execute("INSERT INTO `product` VALUES (" + str(idint) + ", '银票直投"+ time_str +"', '300.0000', '6.50', null, '300.0000', '0.0000',"
                     " '0.00', '30', '2', '1', '1', '1', null, null, '2017-04-27 02:30:01', '2017-04-27 02:30:01', null, null,"
...
# investID = self.query("SELECT id FROM `invest` WHERE 'productId'=" + str(idint) + " ORDER BY id DESC LIMIT 1;")
# DB().make_product()